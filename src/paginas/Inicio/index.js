...
export default function Inicio() {
  return (
    <div className={styles.container}>
      <img className={styles.imagem1} alt="imagem1 para telas pequenas" src={imagem1}/>
      <div className={styles.container__texto}>
        <h1 className={styles.container__titulo}>
          Olá, sou o <span style={{ fontWeight: "900" }}>Vitor Marquez.</span> Iniciando minha carreira como <span className={styles.desenvolvedor}>desenvolvedor</span>
        ...
        <p className={styles.container__paragrafo}>
          ...
          UFU, decidi transicionar minha carreira para a área de tecnologia, mas
          precisamente como desevolver de software. Atualmente meu foco é
